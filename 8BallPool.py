...
pygame.display.set_caption("PbG2")
...
def border():
    pygame.draw.rect(display, green, (0, 0, width, 30))
    pygame.draw.rect(display, green, (0, 0, 30, height))
    pygame.draw.rect(display, green, (width - 30, 0, width, height))
    pygame.draw.rect(display, green, (0, height - 30, width, height))
